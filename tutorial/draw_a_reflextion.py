...
from utils.lattice_utils import get_reciprocal_vectors_2D
...
def draw_reciprocal_1(save_fig=False, show_fig=False):
    # plotting params
    range_a = (-15, 15)
    range_b = (-15, 15)

    reciprocal_a, reciprocal_b = get_reciprocal_vectors_2D(
        vec_a=vec_a,
        vec_b=vec_b,
    ...
    if save_fig:
        plt.savefig('../plots/tutorial/reciprocal_1.png', dpi=300)
    if show_fig:
        plt.show()
...
def draw_reciprocal_2(save_fig=False, show_fig=False):
    # plotting params
    range_a = (-15, 15)
    range_b = (-15, 15)
    ...
    if save_fig:
        plt.savefig('../plots/tutorial/reciprocal_2.png', dpi=300)
    if show_fig:
        plt.show()
...
if __name__ == '__main__':
    ...
    fig, ax = draw_reciprocal_1(
        save_fig=True,
        show_fig=True,
    )

    fig, ax = draw_reciprocal_2(
        save_fig=True,
        show_fig=True,
    )
